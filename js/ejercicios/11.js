...
var ejercicioData = {
    ...
    pasos: [
        ...
        {
            explicacion: "Para encontrar la <span class='keyword-concept'>intersección con el eje X</span> (raíces), hacemos $y=0$. En la forma canónica, $0 = -\\frac{1}{3}(x-9)^2 + 25$.",
            formula: "-\\frac{1}{3}(x-9)^2 + 25 = 0"
        },
        {
            explicacion: "Despejamos $(x-9)^2$: $-\\frac{1}{3}(x-9)^2 = -25 \\implies (x-9)^2 = 75$.",
            formula: "(x-9)^2 = 75"
        },
        {
            explicacion: "Sacamos la raíz cuadrada: $x-9 = \\pm \\sqrt{75}$. Simplificamos $\\sqrt{75} = \\sqrt{25 \\times 3} = 5\\sqrt{3}$.",
            formula: "x - 9 = \\pm 5\\sqrt{3}"
        },
        {
            explicacion: "Las intersecciones con el eje X (raíces) son $x = 9 \\pm 5\\sqrt{3}$. Los puntos de corte con el eje X son $(9 - 5\\sqrt{3}, 0)$ y $(9 + 5\\sqrt{3}, 0)$.",
            formula: "x = 9 \\pm 5\\sqrt{3} \\implies \\text{Puntos de corte X: } (9 - 5\\sqrt{3}, 0), (9 + 5\\sqrt{3}, 0)"
        },
        {
            explicacion: "A partir de las raíces $r_1 = 9 - 5\\sqrt{3}$ y $r_2 = 9 + 5\\sqrt{3}$, podemos escribir la función en su <span class='keyword-concept'>forma factorizada</span> o <span class='keyword-concept'>forma raíz</span>: $F(x) = a(x-r_1)(x-r_2)$.",
            formula: "F(x) = -\\frac{1}{3}(x - (9 - 5\\sqrt{3}))(x - (9 + 5\\sqrt{3}))"
        },
        {
            tipo: 'solucionFinal',
            formula: "\\text{La gráfica es una parábola con vértice en } (9, 25) \\text{ que abre hacia abajo, y tiene intersecciones con el eje Y en } (0, -2) \\text{ y con el eje X en } (9 \\pm 5\\sqrt{3}, 0)."
        }
    ],
    ...
    grafico: {
        ...
        // Aseguramos la correcta precedencia de operadores usando (-1/3)*(x**2)
